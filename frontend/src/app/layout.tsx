...
const links = [
  { text: "ホーム", href: "/" },
  { text: "バー一覧", href: "/bars" },
  { text: "新着レビュー", href: "/reviews" },
  { text: "ランキング", href: "/ranking" },
  { text: "お気に入り", href: "/favorites" },
];

export const metadata: Metadata = {
  title: "Neon Spirits | バーレビューサイト",
  description: "ネオン輝くバーの情報とレビューを共有するコミュニティ",
};
              ...
              <div className="flex items-center gap-2">
                ...
                <Link href="/" className="flex items-center">
                  <p className="text-xl font-semibold tracking-wide neon-glow-soft">
                    NEON <span className="text-neon-pink">S</span>PIRITS
                  </p>
